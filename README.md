...
<div class="project-card">
  ...
  <p><b>Деректер жиынтығы (Dataset):</b><br>
  Ашық дереккөзден алынуы тиіс (Kaggle, UCI, Open Data және т.б.)<br>
  Датасетке нақты сілтеме міндетті түрде көрсетілуі керек</p>
  
  <p><b>Деректерді өңдеу және модельдеу:</b><br>
  Деректерді алдын ала өңдеу (missing values, encoding, scaling)<br>
  Кемінде 2 түрлі Machine Learning моделі қолданылуы тиіс<br>
  Модельдерді оқыту (training) және салыстыру</p>
  
  <p><b>Талдау және бағалау:</b><br>
  Exploratory Data Analysis (EDA) жүргізу<br>
  Модельдердің сапасын бағалау<br></p>
  
  <p><b>Жоба нәтижесін рәсімдеу:</b><br>
  Барлық жұмыс Jupyter Notebook форматында болуы тиіс<br></p>
  
  <p><b>GitHub репозиторий:</b><br>
  Жоба толықтай GitHub-репоға жүктелуі тиіс<br></p>
  
  <p><b>📦 Тапсыру форматы:</b><br>
  Jupyter Notebook (.ipynb)<br>
  GitHub репозиторий сілтемесі</p>
</div>
