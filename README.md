...
<div class="info-box">
  ...
  <ul>
    ...
    <li>Практикалық сабақтар: аптасына 1 рет өтеді</li>
...
<div class="info-box" style="margin-top: 20px; border-left: 5px solid #28a745; background-color: #f9fff9; padding: 15px;">
  <h2>📊 Үлгерім журналы</h2>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="https://drive.google.com/drive/folders/1AarpvrwO8mudNGQ36YNGsNkJR9_ZLtmS?usp=sharing">📝 Дәріс жазбасы</a></td>
      <td><a href="https://drive.google.com/drive/folders/1pEXz-uymEuFRSHBUuzl5TASncJFB5plt?usp=sharing">💻 Практика</a></td>
      <td><a href="https://colab.research.google.com/drive/1Y6pBt-bhZtvz6nvvXSARh7ajy7S3bJtA?usp=drive_link">🧩 СӨЖ</a></td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="https://drive.google.com/drive/folders/1v9q_obQ8lhHuLUe7AfUHajZ10f8X3O9t?usp=sharing">📝 Дәріс жазбасы</a></td>
      <td><a href="https://drive.google.com/drive/folders/1Vy1WoRnBequZNYCyyWAEIb5XQhG66QAr?usp=sharing">💻 Практика</a></td>
      <td><a href="https://drive.google.com/file/d/1i0WFwLZL0oiH1bgGwluDAv788Rrrz-A3/view?usp=drive_link">🧩 СӨЖ</a></td>
    </tr>
    <tr>
...
<div class="project-card">
  ...
  <p><b>📌 Тақырып:</b> Студент өз бетінше Machine Learning жобасына арналған тақырып таңдайды (мысалы: студенттің үлгерімін болжау, үй бағасын болжау, спам анықтау және т.б.)</p>
  
  <p><b>Негізгі талаптар:</b></p>
  
  <p><b>Деректер жиынтығы (Dataset):</b></p>
  <ul>
    <li>Ашық дереккөз (Kaggle, UCI, Open Data)</li>
    <li>Датасетке нақты сілтеме</li>
  </ul>
  
  <p><b>Деректерді өңдеу және модельдеу:</b></p>
  <ul>
    <li>Алдын ала өңдеу (missing, encoding, scaling)</li>
    <li>Кемінде 2 ML модель оқыту</li>
    <li>Оқыту және салыстыру</li>
  </ul>
  
  <p><b>Талдау және бағалау:</b></p>
  <ul>
    <li>EDA жүргізу</li>
    <li>Модель сапасын бағалау</li>
  </ul>
  
  <p><b>Жоба нәтижесін рәсімдеу:</b></p>
  <ul>
    <li>Jupyter Notebook форматында</li>
  </ul>
  
  <p><b>GitHub репозиторий:</b></p>
  <ul>
    <li>Жоба толықтай GitHub-репоға жүктелуі тиіс</li>
  </ul>
  
  <p><b>📦 Тапсыру форматы:</b></p>
  <ul>
    <li>Jupyter Notebook (.ipynb)</li>
    <li>GitHub репозиторий сілтемесі</li>
  </ul>
</div>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="https://drive.google.com/file/d/1Z2cMakiOXzUwyy8PHKs49ivY2iLav1ce/view?usp=drive_link">🧩 СӨЖ</a></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><a href="https://colab.research.google.com/drive/1wN_AfwYTmSXBSG6Goe4_db-qdeVF8jqr?usp=drive_link">🧩 СӨЖ</a></td>
    </tr>
    <tr>
...
<div class="project-card">
  ...
  <p><b>📌 Тақырып:</b> Студент өз бетінше Neural Network / Deep Learning жобасын орындайды (мысалы: сурет классификациясы, мәтін анализі, дыбыс тану және т.б.)</p>
  ...
  <p><b>Деректерді өңдеу және модельдеу:</b></p>
  <ul>
    <li>Алдын ала өңдеу</li>
    <li>Кемінде 2 нейрондық желі моделін оқыту</li>
    <li>Модельдерді салыстыру</li>
  </ul>
  ...
  <p><b>Жоба нәтижесін рәсімдеу:</b></p>
  <ul>
    <li>Jupyter Notebook немесе Visual Studio Code</li>
  </ul>

  <p><b>GitHub репозиторий:</b></p>
  <ul>
    <li>Жоба GitHub-қа жүктелуі тиіс</li>
  </ul>

  <p><b>📦 Тапсыру форматы:</b></p>
  <ul>
    <li>.ipynb немесе VS Code project</li>
    <li>GitHub репозиторий сілтемесі</li>
  </ul>
</div>
...
<div class="project-card">
  ...
  <p><b>Әдіс:</b> CNN + Transfer Learning // кез-келген <a href="https://www.kaggle.com/datasets/yerassylis/plant-disease-recognition-lightweight-128x128/data"> жүктеу </a> </p>
  <p><b>GitHUB жұмыс орынын clone:</b> <a href="#"></p>
  ...
  <p><b>Кезеңдер:</b> деректерді жүктеу → augmentation → pre-trained модель → fine-tuning → метрика талдауы (Accuracy, Precision, Recall, F1, Confusion Matrix) // жетілдіру өз қалауыңызда</p>
</div>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="https://drive.google.com/drive/folders/1GV7XRRRwtbQBkpCQSbK5ohU0mU5GwVHL?usp=drive_link">🎤 Дәріс жазбасы</a></td>
...
<div class="info-box">
  ...
  <ul>
    <li><b>Kaggle:</b> kaggle.com - деректер жиынтықтары және жарыстар</li>
    <li><b>Scikit-learn:</b> scikit-learn.org - классикалық ML кітапханасы</li>
    <li><b>PyTorch:</b> pytorch.org - терең оқыту фреймворкі</li>
    <li><b>HuggingFace:</b> huggingface.co - NLP модельдері</li>
    <li><b>Papers with Code:</b> paperswithcode.com - ғылыми мақалалар және код</li>
  </ul>
...
<div class="info-box">
  ...
  <ul>
    <li>Байланыс: sup.itechresearch@gmail.com +7(701)726 8544</li>
  </ul>
</div>
